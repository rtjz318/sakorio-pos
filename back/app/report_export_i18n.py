...
_EN: dict[str, str] = {
    ...
    "sheet_by_payment_method": "By payment method",
    "date": "Date",
    "revenue_cents": "Revenue (cents)",
    "cost_cents": "Cost (cents)",
    "profit_cents": "Profit (cents)",
    "collected_cents": "Collected (cents)",
    "average_ticket_cents": "Average ticket (cents)",
    "share_of_collected_sales_pct": "Share of collected sales (%)",
    "orders": "Orders",
    "total": "Total",
