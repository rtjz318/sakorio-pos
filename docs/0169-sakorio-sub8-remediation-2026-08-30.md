...
| QA-168-05 / E2E-036: old fixed QR exposed old bill | Public table sessions older than 24 hours are locked for guests. Staff see an explicit stale-session warning and can review/settle/close the preserved bill. Staff links retain review access. | Removes cross-visit QR exposure without deleting accounting records. |
