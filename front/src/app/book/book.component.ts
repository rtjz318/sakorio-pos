...
@Component({
  selector: 'app-book',
  standalone: true,
  imports: [FormsModule, RouterLink, TranslateModule, LanguagePickerComponent, ReservationWeekSlotGridComponent, LegalLinksComponent],
...
export class BookComponent implements OnInit {
  ...
  goManageReservation(event?: Event): void {
