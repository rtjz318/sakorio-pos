        ...
        <div class="toolbar">
          ...
          <div class="toolbar-right">
            ...
            <div class="view-toggle" role="group" aria-label="View">
              <button type="button" class="btn-view" [class.active]="viewMode() === 'tile'" (click)="viewMode.set('tile')" title="Tile view">â–¦</button>
              <button type="button" class="btn-view" [class.active]="viewMode() === 'list'" (click)="viewMode.set('list')" title="List view">â‰¡</button>
            </div>
          </div>
        </div>
            ...
            @for (p of filteredProducts(); track p.id) {
              <div class="product-card">
                ...
                <div class="product-body">
                  ...
                  <p class="price">{{ p.price_cents != null ? (p.price_cents / 100 | number:'1.2-2') + ' $' : 'â€”' }}</p>
              ...
              <tbody>
                @for (p of filteredProducts(); track p.id) {
                  <tr>
                    <td>
                      <div class="list-product-cell">
                        @if (p.image_url) {
                          ...
                          <span class="list-thumb list-thumb-empty">â€”</span>
                        }
                        <div>
                    ...
                    <td>{{ p.price_cents != null ? (p.price_cents / 100 | number:'1.2-2') + ' $' : 'â€”' }}</td>
                    <td>
                      <span class="badge" [class.available]="p.availability" [class.unavailable]="!p.availability">
                        {{ p.availability ? 'Available' : 'Unavailable' }}
                      </span>
