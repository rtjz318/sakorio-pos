      ...
      <aside class="sidebar">
        ...
        <nav class="nav" #navScroll (scroll)="persistNavScroll()">
           ...
           @if (canViewReservations() && moduleEnabled('reservations')) {
             ...
             <a routerLink="/queue" routerLinkActive="active" class="nav-link" (click)="closeSidebar()">
               <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                 <path d="M17 6h.01"/><path d="M13 6h.01"/><path d="M7 6h.01"/>
                 <path d="M3 12h18"/><path d="M7 18h10"/>
